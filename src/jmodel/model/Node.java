...
public class Node {
    ...
    public Node(String title, String id, Model.MODEL_TYPE type, String[] attributes, String[] signals) {
        this();
    ...
    public Node(String title, String id, Model.MODEL_TYPE type, ArrayList<String> attributes, ArrayList<String> signals) {
        this();
        this.setTitle(title);
        this.setId(id);
        this.setType(type);
